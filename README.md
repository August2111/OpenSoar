...
... and OpenSoar is a tactical glide computer for Android, Linux, Mac OS X and Windows.
...
downloaded via the [XCSoar home page](https://xcsoar.org/discover/manual.html), because ther is no difference yet.
