...
static constexpr Item internal_polars[] = {
  ...
  { "Astir CS Jeans", 330, 90, 80.0, -0.730, 95.0, -0.810, 150.0, -1.920, 12.40, 47.22, 96, 296 }, // from CondorUtil (condorutill.fr)
  { "AS-33 Me (15m)", 485, 139, 126.2, -0.700, 163.1, -1.050, 200.0, -1.670, 8.80, 55.56, 116, 320 }, // from CondorUtil (condorutill.fr)
  { "AS-33 Me (18m)", 495, 170, 116.2, -0.590, 158.1, -0.990, 200.0, -1.760, 10.00, 55.56, 122, 330 }, // from CondorUtil (condorutill.fr)
  ...
  { "ASG-32 Mi", 694, 120, 115.8, -0.620, 157.9, -1.080, 200.0, -2.000, 15.70, 50.0, 120, 545 }, // from Gliding Australia Polar10.xls (via Wayback Machine)
  ...
  { "Bergfalke II", 300, 0, 70.0, -0.910, 80.0, -0.960, 150.0, -3.420, 17.70, 33.33, 74, 243 }, // from Gliding Australia Polar10.xls (via Wayback Machine)
  { "Bergfalke IV", 350, 0, 75.0, -0.850, 90.0, -0.970, 150.0, -2.560, 17.88, 47.22, 80, 262 }, // from Gliding Australia Polar10.xls (via Wayback Machine)
  ...
  { "Calif A-21S", 500, 0, 80.0, -0.690, 120.0, -0.880, 150.0, -1.260, 16.19, 46.94, 108, 392 }, // from Gliding Australia Polar10.xls (via Wayback Machine)
  ...
  { "DG-101 G", 315, 100, 90.2, -0.650, 145.1, -1.620, 200.0, -3.750, 11.0, 45.83, 100, 340 }, // from CondorUtil (condorutill.fr)
  ...
  { "DG-303", 310, 190, 80.0, -0.546, 95.0, -0.609, 150.0, -1.649, 10.27, 55.56, 104, 310 }, // from Gliding Australia Polar10.xls (via Wayback Machine)
  ...
  { "DG-800 (18m) WL", 472, 120, 106.0, -0.620, 171.8, -1.470, 214.8, -2.400, 11.81, 52.8, 119, 344 }, // from LK8000
  ...
  { "DG-808C (15m)", 447, 156, 108.8, -0.640, 154.4, -1.130, 200.0, -2.060, 10.68, 52.8, 113, 340 }, // from Gliding Australia Polar10.xls (via Wayback Machine)
  { "DG-808C (18m)", 451, 156, 102.3, -0.560, 151.1, -1.100, 200.0, -2.180, 11.81, 52.8, 120, 340 }, // from CondorUtil (condorutill.fr)
  ...
  { "EB 29 R", 714, 174, 100.2, -0.400, 150.1, -0.770, 200.0, -1.500, 14.90, 50.0, 129, 350 }, // from Gliding Australia Polar10.xls (via Wayback Machine)
  { "Elfe S4D", 350, 100, 80.0, -0.690, 90.0, -0.720, 150.0, -1.890, 11.80, 41.67, 96, 270 }, // from Gliding Australia Polar10.xls (via Wayback Machine)
  ...
  { "Grunau Baby", 240, 0, 60.5, -0.980, 95.2, -2.280, 130.0, -5.040, 14.20, 0.0, 54, 150 }, // from CondorUtil (condorutill.fr)
  ...
  { "HPH 304 eS Shark", 445, 200, 99.6, -0.550, 149.8, -1.100, 200.0, -2.230, 11.80, 50.0, 119, 280 }, // from CondorUtil (condorutill.fr)
  ...
  { "JS-1B (18m)", 405, 192, 101.7, -0.540, 150.9, -1.090, 200.0, -2.250, 11.19, 56.3, 121, 310 }, // from factory polar
  { "JS-1C (21m)", 441, 226, 101.0, -0.470, 150.5, -1.050, 200.0, -2.330, 12.25, 56.3, 126, 330 }, // from factory polar
  ...
  { "Ka 6 CR", 265, 0, 77.58, -0.74, 123.79, -1.74, 170.0, -3.85, 12.4, 38.89, 82, 185 }, // from LK8000
  { "Ka 6E",  310, 0, 87.35, -0.81, 141.92, -2.03, 174.68, -3.5, 12.4, 38.89, 85, 185 }, // from idaflieg measured 1970
  { "Ka 7", 445, 0, 87, -0.92, 120, -1.55, 150, -2.7, 17.5, 0.0, 78, 285 },
  { "Ka 8", 290, 0, 74.1, -0.76, 101.9, -1.27, 166.7, -4.64, 14.15, 0.0, 76, 190 },
  { "Ka 10", 300, 0, 70.0, -0.700, 80.0, -0.730, 130.0, -1.930, 12.53, 0.0, 0, 245 }, // from Gliding Australia Polar10.xls (via Wayback Machine)
  { "Kranich III", 300, 0, 70.0, -0.800, 90.0, -0.950, 150.0, -3.040, 12.00, 36.11, 80, 242 }, // from Gliding Australia Polar10.xls (via Wayback Machine)
  { "L-33 Solo", 330, 0, 87.2, -0.8, 135.64, -1.73, 174.4, -3.4, 11.0, 0.0, 86, 210 },
  { "L-Spatz 55", 300, 0, 70.0, -0.800, 75.0, -0.840, 105.0, -1.420, 10.9, 30.56, 78, 213 }, // from Gliding Australia Polar10.xls (via Wayback Machine)
  ...
  { "LAK-17a MINI  FES (13.5m)", 325, 80, 105.9, -0.740, 153.0, -1.420, 200.0, -2.820, 8.41, 47.22, 103, 240 }, // from CondorUtil (condorutill.fr)
  ...
  { "SF-28", 510, 0, 90.8, -1.010, 130.4, -1.850, 170.0, -3.490, 18.35, 43.33, 78, 200 }, // from CondorUtil (condorutill.fr)
  { "SF-34", 500, 0, 90.0, -0.830, 105.0, -0.900, 150.0, -1.800, 14.80, 47.78, 86, 361 }, // from Gliding Australia Polar10.xls (via Wayback Machine)
  { "SG-38", 200, 0, 62.0, -2.070, 81.0, -3.210, 100.0, -5.340, 16.00, 16.67, 0, 150 }, // from CondorUtil (condorutill.fr)
  ...
  { "Silent 2 electro", 276, 0, 80.0, -0.650, 90.0, -0.650, 150.0, -1.550, 8.90, 41.67, 94, 205 }, // from LK8000
  ...
  { "Stemme S-12", 820, 0, 105.1, -0.550, 152.6, -1.050, 200.0, -2.030, 19.95, 50.0, 114, 400 }, // from CondorUtil (condorutill.fr)
  { "Swift S-1", 350, 0, 117.9, -1.100, 159.0, -1.770, 200.0, -3.000, 11.73, 65.56, 77, 280 }, // from CondorUtil (condorutill.fr)
  ...
  { "SZD-38A Jantar 1", 372, 90, 90.0, -0.530, 130.0, -1.070, 170.0, -2.000, 13.38, 44.44, 112, 325 }, // from LK8000
  ...
  { "SZD-55-2 Diana 2", 270, 250, 100.5, -0.557, 146.3, -1.147, 185.6, -2.146, 8.64, 55.0, 116, 280 }, // from LK8000
  ...
  { "Ventus 3 (15m)", 370, 156, 110.5, -0.620, 155.3, -1.130, 200.0, -2.180, 9.53, 55.6, 116, 290 }, // from CondorUtil (condorutill.fr)
  { "Ventus 3 (18m)", 390, 186, 101.6, -0.520, 150.8, -1.080, 200.0, -2.250, 10.84, 55.6, 122, 300 }, // from CondorUtil (condorutill.fr)
  // from LK8000
  ...
  { "Zugvogel IV", 300, 0, 70.0, -0.700, 75.0, -0.740, 135.0, -1.930, 13.43, 38.89, 86, 242 }, // from Gliding Australia Polar10.xls (via Wayback Machine)
